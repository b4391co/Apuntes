        ...
        <table class="table table-striped table-dark mt-3">
            ...
            <tbody>
                ...
                while ($filas = $stmt->fetch(PDO::FETCH_OBJ)) {
                    ...
                    echo "<form action='{$_SERVER['PHP_SELF']}' method='POST' id='datosCesta_{$filas->id}'>";
                    ...
                    echo "<td><input type='number' name='unidades' value='1' min='1' max='3' form='datosCesta_{$filas->id}'></td>";
