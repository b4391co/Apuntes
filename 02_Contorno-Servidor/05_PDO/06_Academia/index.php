...
$fecha = new DateTimeImmutable('2000-05-14');
$alumno1 = new Alumno("Juan", "Antas Ulla", "650650650", $fecha->format(""));
$fecha = new DateTimeImmutable('2020-05-14');
$alumno2 = new Alumno("Rita", "Román Rueda", "652652652",$fecha->format(""));
