...
final class Alumno extends Persoa {
    ...
    public function __construct(string $nome, string $apelidos, string $mobil, string $fechaNacimiento, int $numClases = 0) {
    ...
    public function verInformacion(){
        ...
        if ($diff->format("") > 18)
            $cadea = implode (" ",  [$this->nome,  $this->apelidos, $this->mobil]);
        else
            $cadea = implode (" ",  [$this->nome,  $this->apelidos]);
        echo $cadea;
    }
